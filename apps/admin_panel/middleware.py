...
class AdminPermissionMiddleware:
    ...
    def get_required_permission(self, url_name):
        ...
        return {
            ...
            'admin_liafi_agents':                       'agents',
            'admin_liafi_agents_export':                'agents',
            'admin_lic_agents':                         'agents',
            'admin_lic_agents_export':                  'agents',
            ...
            'admin_content_liafi':                      'content',
            'admin_content_liafi_update':               'content',
