...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        quick_picks = [
            ...
            {'label': 'Fire (SME)', 'badge_text': '', 'badge_bg_color': '', 'badge_text_color': '', 'icon_bg_color': '#fef2f2', 'icon_color': '#dc2626', 'icon': 'store', 'url': '/find-agents?ServiceType=New%20Policy&InsuranceType=SME%20Insurance&InsuranceCompany=Fire%20(SME)&openFilter=1', 'order': 12},
